				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-12'>
					...
					<div className='md:col-span-2 text-muted-foreground text-lg space-y-6'>
						<p>
							...
							Computer Science, where I discovered my passion for web
							development. I was captivated by the ability to create
							applications that could be used by people all over the world.
						</p>
						<p>
							Over the years, I've had the opportunity to work on a variety of
							projects, from large-scale enterprise applications to fast-paced
							startup environments. These experiences have taught me the
							importance of writing clean, maintainable code and the value of
							effective collaboration within a team.
						</p>
						<p>
							Today, I'm focused on leveraging my skills in the .NET and
							JavaScript ecosystems to build robust and scalable full-stack
							solutions.
						</p>
					</div>
				</div>
						...
						<Card>
							...
							<CardContent className='space-y-4 text-muted-foreground'>
								<p>
									...
									Functionality should be intuitive and the experience seamless.
								</p>
								<p>
									<strong>Clean & Scalable Code:</strong> I write code that is
									not only effective but also easy for other developers to read,
									maintain, and build upon.
								</p>
								<p>
									<strong>Continuous Learning:</strong> The tech landscape is
									always evolving, and I am committed to staying current with
