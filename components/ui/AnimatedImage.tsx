...
const AnimatedImage: React.FC<AnimatedImageProps> = ({ src, alt, width, height, className, ...props }) => {
    ...
    const blurDataURL = typeof src === 'string' ? `${src.split('?')[0]}?w=10&q=5&fm=webp` : undefined;
