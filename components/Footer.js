...
<div className="">
    ...
    <div className=" bg-gray-800 py-12 md:items-center ">

    <div className="mb-8 container md:mt-0 md:order-1 container mx-auto">
      <p className="text-center md:mx-64 text-sm md:text-base text-white italic">
         “The heights by great men reached and kept were not attained by sudden flight, but they while their companions slept, were toiling upward in the night.” <br />  ~ Henry Wadsworth Longfellow
      </p>
    </div>
      ...
      <div className="mt-8 container md:mt-0 md:order-1 container mx-auto">
        <p className="text-center text-sm md:text-base text-white">
          &copy; 2021 Kenny Whyte. All rights reserved.
        </p>
      </div>
    </div>
    </div>
