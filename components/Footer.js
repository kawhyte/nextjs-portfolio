...
const Footer = () => {
  let year = new Date().getFullYear();
	return (
		<div className=''>
		<svg class="fill-current text-gray-800 inline-block h-12 w-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 30" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
